...
public class GetReportSample {
     ...
     * @param args unused
     */
    public byte[] sendRequest(String sellerId, String mwsToken, String generatedReportId) {
...
//        String tsvString = new String();
        ...
        request.setReportOutputStream(binaryOutput);

        invokeGetReport(service, request);
        
        byte[] bytes = binaryOutput.toByteArray();
...
//            System.out.println( request.getReportOutputStream().toString() );
            Writer writer = new OutputStreamWriter(request.getReportOutputStream());
            System.out.println();
